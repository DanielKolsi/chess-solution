...
export default {
  pieces: [
    ...
    [18, "BishopBC", "bbc", 2, false, -4],
    
    [13, "KingB", "bk", 4, false, -6],
    
    
    [39, "RookBH", "brh", 7, false, -5],
    ...
    [42, "KnightWB", "wkb", 57, true, 3],
    [58, "BishopWC", "wbc", 58, true, 4],
    
    [60, "KingW", "wk", 60, true, 6],

    [45, "KnightWG", "wkg", 62, true, 3],
